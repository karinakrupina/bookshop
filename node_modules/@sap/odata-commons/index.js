...
module.exports = {
    ...
    deserializer: {
        ValueTextDeserializer: require('./lib/deserializer/ValueTextDeserializer')
    },
    edm: {
    ...
    serializer: {
        ValueTextSerializer: require('./lib/serializer/ValueTextSerializer')
    },
    uri: {
    ...
    utils: {
        ValueConverter: require('./lib/utils/ValueConverter'),
        Character: require('./lib/utils/Character')
    },
    validator: {
