...
class ValueConverter {
    ...
    convertBinary(value, maxLength) {
        ...
        return value.toString('base64')
            ...
            .replace(PLUS_REGEXP, '-').replace(SLASH_REGEXP, '_');
    }
    ...
    convertInt64(value) {
        ...
        if (bigValue.lt(Number.MIN_SAFE_INTEGER) || bigValue.gt(Number.MAX_SAFE_INTEGER)) {
            throw new IllegalArgumentError(`The Edm.Int64 value ${value} cannot be correctly serialized as an ` +
    ...
    convertDecimal(value, precision, scale) {
        ...
        if (scale === null || scale === undefined || scale === 0) {
            ...
            if (bigValue.lt(Number.MIN_SAFE_INTEGER) || bigValue.gt(Number.MAX_SAFE_INTEGER)) {
                throw new IllegalArgumentError(`The Edm.Decimal value ${value} cannot be correctly serialized as an ` +
        ...
        if ((absBigValue.lt(Number.MIN_VALUE) && absBigValue.gt(0)) || absBigValue.gt(Number.MAX_VALUE)) {
            throw new IllegalArgumentError(`The Edm.Decimal value ${value} cannot be correctly serialized as a ` +
