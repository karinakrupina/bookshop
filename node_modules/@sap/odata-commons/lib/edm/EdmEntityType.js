...
class EdmEntityType extends AbstractEdmStructuredType {
    ...
    /**
     * Returns a Map of key properties. These properties define the key in this edm type excluding those from base type.
    ...
    hasStream() {
        ...
        if (this.getBaseType()) return this.getBaseType().hasStream();
