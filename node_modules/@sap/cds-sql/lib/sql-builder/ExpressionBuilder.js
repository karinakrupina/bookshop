...
class ExpressionBuilder extends BaseBuilder {
  ...
  _addSubQueryForInQuery (reference, operator, subQuery) {
    ...
    this._addToOutputObj(new this.SelectBuilder(subQuery, this._options, this._csn).build(), true)
  }
  ...
  _expressionElementToSQL (element) {
    ...
    for (const key of Object.keys(element)) {
      switch (key) {
        ...
        case 'SELECT':
          return this._addToOutputObj(new this.SelectBuilder(element, this._options, this._csn).build(), true)
        case 'func':
