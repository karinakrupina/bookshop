module.exports = function (conf) {
  const _ = Object.defineProperties (conf, {
    build: {value:{__proto__:{
      get dest() { return '.' },
      // get dest() { return _.build.target || '.' },
      // set dest(v) { _.build.target = v},
      get version() { return 1.4 },
      set 'new-csn'(v) { _.cdsc.newCsn = v }, // build.new-csn is available since 2.9
      get 'new-csn'() { return _.cdsc.newCsn }
    }}},
    data: {value:{
      get model(){
